...
namespace FFTInformatica.Controllers
{
    ...
    public class ResponsesController : ControllerBase
    {
        ...
        // GET: api/Responses/5
        [HttpGet("{id}")]
        public async Task<IActionResult> GetResponse([FromRoute] long id)
        {
        ...
        // PUT: api/Responses/5
        [HttpPut("{id}")]
        public async Task<IActionResult> PutResponse([FromRoute] long id, [FromBody] Response response)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
        ...
        [HttpDelete("{id}")]
        public async Task<IActionResult> DeleteResponse([FromRoute] long id)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
